/*
Used to generate GadgetProbe payloads in base64 with free DNSbins: 
(https://interact.projectdiscovery.io/) or (https://requestbin.net/dns) or (https://dnsbin.zhack.ca)
Usage: java -cp '.:GadgetProbe-1.0-SNAPSHOT-all.jar' gen_payloads.java wordlist.txt XXXXXXXXXXXXXX.interact.sh
